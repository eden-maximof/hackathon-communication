...
def send_udp_clients(server_port_tcp):
...
def run_server():
    ...
    udp_server_socket.bind((our_ip, 31296))# need to check again !!!

    tcp_server_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    tcp_server_socket.bind((our_ip, 41687))############
    ...
    while running:
        ...
        thread_send_udp_clients = threading.Thread(target=send_udp_clients, args=(server_port_tcp,))
